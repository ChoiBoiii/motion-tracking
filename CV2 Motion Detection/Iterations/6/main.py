...
def main():
    ...
    mod7Surf = UI.outputSurf(2, 2, X/IMG_OUT_NUM_DIM, Y/IMG_OUT_NUM_DIM)
    ...
    while run:
        ...
        mod7OutFrame = models.model_6(greyFrame, prevGreyFrame)
        ...
        mod6Surf.scale()
        # Method 6
        mod7Surf.surf = frameToPygameSurf(mod7OutFrame, cv2.COLOR_BGR2RGB)
        mod7Surf.scale()
